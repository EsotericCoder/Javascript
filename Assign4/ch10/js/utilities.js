...
var U = {
    ...
    //Bullet 3 & 5- added addTooltipHandlers
    ...
    addTooltipHandlers: function(id) {
        ...
        newId.onmouseover = this.showTooltip(newId);
        newId.onmouseout = this.hideTooltip(newId);
        newId.onfocus = this.showTooltip(newId);
        newId.onblur = this.hideTooltip(newId);
